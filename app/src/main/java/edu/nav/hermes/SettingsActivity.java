...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    protected boolean isValidFragment(String fragmentName) {
        return PreferenceFragment.class.getName().equals(fragmentName)
                || AlgorithmPreferenceFragment.class.getName().equals(fragmentName)
    ...
    public static class AlgorithmPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("pref_algoritmo_algoritmo"));
            bindPreferenceSummaryToValue(findPreference("pref_algoritmo_heuristica"));
        }
    ...
    public static class PerformancePreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // updated to reflect the new value, per the Android Design
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("pref_performance_cache_size"));
        }
